...
<table cellspacing="0" style="border-collapse:collapse; width:1911px">
    <tbody>
        <tr>
            ...
            <td rowspan="2" style="background-color:#d9d9d9; border-bottom:2px solid black; border-left:1px solid black; border-right:2px solid black; border-top:none; text-align:center; vertical-align:middle; white-space:nowrap; width:93px"><span style="font-size:15px"><strong><span style="color:black"><span style="font-family:Calibri,sans-serif">&nbsp;&nbsp;&nbsp;&nbsp; {{number_format($totalrdbentregado,0,',','.')}}</span></span></strong></span></td>
