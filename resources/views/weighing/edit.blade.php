...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
       ...
       <center><h1>FORMULARIO DE ACTUALIZACIÓN ({{$weighings->id}} - {{$weighings->NUMTIQUETE}})</h1></center>
       <hr>
  ...
  {!! Form::open(['route' => ['weighing.destroy', $weighings->id], 'method'=>'POST','id'=>'FormCreateeradications']) !!}
    {{method_field('patch')}}
...
<div class="row">
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        ...
        <input type="text" name="NUMREMISION" id="NUMREMISION" class="form-control" value="{{$weighings->NUMREMISION}}" required="required"  title="" readonly>
    </div>
        ...
        <input type="text" name="NETO" id="NETO" class="form-control" value="{{$weighings->NETO}}" required="required"  title="" readonly>
    </div>
    </div>
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        <div class="form-group">    
        ...
        {!! Form::select('PROCEDENCIA',$procedencia, $weighings->PROCEDENCIA, ['class' => 'form-control ','name'=>'PROCEDENCIA','id'=>'PROCEDENCIA' ,'placeholder'=>'Seleccione...', 'required']) !!}
    </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        ...
        <input type="text" name="PLACA" id="PLACA" class="form-control" value="{{$weighings->PLACA}}" required="required"  title=""readonly>
    </div>
...
<div class="row">
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        ...
        <input type="text" name="FEC_RECEPCION" id="FEC_RECEPCION" class="form-control" value="{{$weighings->FEC_RECEPCION}}" required="required"  title="" readonly>
    </div>
        ...
        {!! Form::select('NUMTIQUETE',$codigo, $weighings->NUMTIQUETE, ['class' => 'form-control bascula','name'=>'NUMTIQUETE','id'=>'NUMTIQUETE' ,'placeholder'=>'Seleccione...', 'required']) !!}
        ...
        <input type="text" name="NETO_REC_KILOS" id="NETO_REC_KILOS" class="form-control" value="{{$weighings->NETO_REC_KILOS}}" required="required"  title="" readonly>
    </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        ...
        <input type="text" name="DIFERENCIAS_ORIGEN" id="DIFERENCIAS_ORIGEN" class="form-control" value="{{$weighings->DIFERENCIAS_ORIGEN}}" required="required"  title="" readonly>
        </div>
...
<div class="row">
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        ...
        <input type="text" name="NETO_AGL_APROD_KG" id="NETO_AGL_APROD_KG" class="form-control" value="{{$weighings->NETO_AGL_APROD_KG}}" required="required"  title="" readonly>
    </div>
    </div>
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <div class="form-group">
        <span class="label">Neto agl a cesionar a Palmeras</span>
        <input type="text" name="NETO_AGL_ACES_KG" id="NETO_AGL_ACES_KG" class="form-control" value="{{$weighings->NETO_AGL_ACES_KG}}" required="required"  title="" readonly>
    </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        ...
        <input type="text" name="NETO_AGL_ENT_BIOD_KG" id="NETO_AGL_ENT_BIOD_KG" class="form-control" value="{{$weighings->NETO_AGL_ENT_BIOD_KG}}" required="required"  title="" readonly>
    </div>
        ...
        <input type="text" name="NETO_MERMA" id="NETO_MERMA" class="form-control" value="{{$weighings->NETO_MERMA}}" required="required"  title="" readonly>
    </div>
    </div>
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            <div class="form-group">
            <span class="label">RBD a entregar KG</span>
      <input type="text" name="RDB" id="RDB" class="form-control" value="{{$weighings->RDB}}" required="required"  title="" readonly>   
  </div>
    </div>
</div>
