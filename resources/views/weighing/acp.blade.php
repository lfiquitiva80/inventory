...
<div class="inner">
<h3>{{ number_format($saldoacp,0,',','.')}}<sup style="font-size: 20px">Kls</sup></h3>
...
<div class="inner">
<h3>{{ number_format($saldo_cpo,0,',','.')}}<sup style="font-size: 20px">Kls</sup></h3>
<p>TERCEROS </p>
</div>
<div class="icon">
...
<div class="inner">
<h3>{{ number_format($diferenciacpo,0,',','.')}}<sup style="font-size: 20px">Kls</sup></h3>
<p>PROPIO </p>
</div>
<div class="icon">
<i class=""></i>
